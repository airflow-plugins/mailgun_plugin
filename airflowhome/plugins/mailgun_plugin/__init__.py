...
Note: The email validation API is _not free_ and charges per validation check, not per email address, so we should be conscious of running more than once for a given email.
"""
